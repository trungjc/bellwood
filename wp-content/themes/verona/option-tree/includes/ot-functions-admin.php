...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 'ot-admin-js', OT_URL . 'assets/js/ot-admin.js', array( 'jquery', 'jquery-ui-tabs', 'jquery-ui-sortable', 'media-upload', 'thickbox', 'jquery-ui-dialog' ), OT_VERSION );
