              ...
              echo '<div id="option-tree-settings-api">';
                ...
                echo '<div id="topper">';
                  echo '<div class="brand">';
                    echo '<img class="logo-brand" src="'. OT_URL . '/assets/images/custom/logo.png" >';
                      ...
                      echo '<ul>';
                        echo '<li>';
                          echo '<a href="'.get_template_directory_uri().'/includes/docs/index.html" target="_blank">';
                            echo '<img src="'. OT_URL . '/assets/images/custom/documentation.jpg" >';
                          echo '</a>';
                        echo '</li>';
                        echo '<li>';
                          echo '<a href="http://support.suitstheme.com" target="_blank">';
                            echo '<img src="'. OT_URL . '/assets/images/custom/forum.jpg" >';
                          echo '</a>';
                        echo '</li>';
                        if ( $show_buttons ) 
                  echo '<button class="option-tree-ui-button topper custom right">' . $page['button_text'] . '</button>';
                      echo '</ul>';
